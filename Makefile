...
ifeq ($(USE_OPT),)
  USE_OPT = -O2 -fomit-frame-pointer -falign-functions=16 -DUSE_MAPLEMINI_BOOTLOADER=${USE_MAPLEMINI_BOOTLOADER} -Winline
endif
...
UDEFS = -DSTDOUT_SD=SD3 -DSTDIN_SD=SD3 -DSHELL_CMD_TEST_ENABLED=FALSE
